      ...
      <section className="support-levels">
        <div className="container school-rights-container">
          <div className="school-section-heading">
            ...
            <p>
              As medidas de suporte à aprendizagem e à inclusão podem ser
              mobilizadas em diferentes níveis, dependendo das necessidades de
              cada aluno.
            </p>
          </div>

          <div className="support-levels-grid">
            <article className="support-level-card universal">
              <div className="support-level-icon">
              ...
              <p>
                ...
                procuram promover a participação e melhorar as aprendizagens.
              </p>

              <ul>
                <li>Diferenciação pedagógica</li>
                <li>Acomodações curriculares</li>
                <li>Enriquecimento curricular</li>
                <li>Promoção do comportamento pró-social</li>
                <li>Intervenções em pequenos grupos</li>
              </ul>
            </article>

            <article className="support-level-card selective">
              <div className="support-level-icon">
              ...
              <ul>
                <li>Percursos curriculares diferenciados</li>
                <li>Adaptações curriculares não significativas</li>
                <li>Apoio psicopedagógico</li>
                <li>Antecipação e reforço das aprendizagens</li>
                <li>Apoio tutorial</li>
              </ul>
            </article>

            <article className="support-level-card additional">
              <div className="support-level-icon">
              ...
              <p>
                Destinam-se a dificuldades acentuadas e persistentes que
                necessitem de recursos especializados.
              </p>

              <ul>
                <li>Adaptações curriculares significativas</li>
                <li>Estratégias de ensino estruturado</li>
                <li>Desenvolvimento da autonomia pessoal e social</li>
                <li>Plano individual de transição, quando aplicável</li>
              </ul>
            </article>
          </div>
        </div>
